      ...
      <div className="item" style={{display:"flex", marginLeft:"100px"}}>
        ...
        >
          ...
          <div
            className="content-1"
            >
            <Typography variant="h5" style={{fontSize:"20px", marginTop:"15px",}}>Rara Sekar</Typography>
          </div>
        </div>
        <hr
          className="underline"
        ...
        >
          ...
          <div className="profile_name" style={{ marginLeft: "10px" }}>
            <h3 style={{fontSize:"16px", marginTop:"73px"}}>Notification</h3>
          </div>
        </div>
        <div
          className="icon-profile"
        ...
        <nav style={{marginTop:"100px"}}>
          <a href="inbox" style={{marginLeft:"30px"}}>Inbox</a>
          <a href="sent" style={{marginLeft:"100px"}}>Sent</a>
        </nav>
        <div style={{display:"flex"}}>
        <div className="container-1" style={{display:"flex", marginTop:"100px"}}>
          <div className="content" style={{marginLeft:"30px"}}>
              <Avatar aria-label="recipe" className={classes.avatar} style={{width:"60px", height:"60px"}}>
                R
              </Avatar>
          </div>
          <div className="content-1">
            <Typography variant="h5" style={{fontSize:"19px"}}>Gedong Putih</Typography>
            <Rating name="read-only" value="3" readOnly />
            <h1 style={{marginTop:"0px", fontSize:"10px"}}>Saturday, 25th Feb 21|16:09</h1>
          </div>
          </div>
          <button style={{marginLeft:"400px", marginTop:"100px", width:"90px", height:"40px"}}>Details</button>
        </div>
          < a href="download" style={{marginLeft:"600px", marginTop:"0px"}}>Quotation attached</a>
        </Card>
      </div>
    </div>
  );
